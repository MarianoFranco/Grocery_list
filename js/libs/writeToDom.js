import { saveToLocalStorage, getStorageItem } from './localStorageHelper.js';

export default function writeToDOM(
	domElementIAmGoingToPutHTMLInto,
	theArrayIAmGoingToCreateHTMLFrom
) {
	console.log(domElementIAmGoingToPutHTMLInto);
	...
	checkboxes.forEach(function (checkbox) {
		checkbox.onclick = function () {
			...
			console.log(theArrayIAmGoingToCreateHTMLFrom[indexOfItem].checked);
